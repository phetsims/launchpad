...
// npx tsx js/server/newServer.ts --port=8003
...
( async () => {
  ...
  //   - Serve built form of phettest client in phettest server (at... root?)
  //   - Dark theme
  // - REST API
  ...
  // Static hosting for phettest build
  app.use( express.static( `${ROOT_DIR}/phettest/dist`, {
    etag: true
  } ) );
