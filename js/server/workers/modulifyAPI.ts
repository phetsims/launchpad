...
export const getModulifiedFile = async (
  ...
  if ( modulifyResponse.modulified && ( file.endsWith( '.js' ) || file.endsWith( '.ts' ) ) ) {
    modulifyResponse.fileContents = `// Auto-generated by launchpad modulify on ${readableTimestamp} with chipper ${chipperSHA} and perennial ${perennialSHA}\n${modulifyResponse.fileContents}`;
  }
